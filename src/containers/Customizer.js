		...
		<div key={varName} className="gx-media gx-mb-1">
			<div className="gx-ml-1 gx-mr-4">
				<ColorPicker
					...
					<span className="gx-pointer gx-text-capitalize gx-media-body">{varName.substr(1, varName.length).replace(/-/g, " ")}</span>
				</ColorPicker>
			</div>
		</div>
	);
				...
				<div className="gx-customizer-item">
					...
					{colorSelection === THEME_COLOR_SELECTION_CUSTOMIZE ? (
						<div className="gx-cus-customiz">
							{colorPickers}
							<Button className="gx-mb-0" type="primary" onClick={this.resetTheme}>
								Reset Theme
							</Button>
						</div>
					) : (
	...
	getLayoutsTypes = layoutType => {
		return (
			<ul className="gx-layout-option gx-list-inline">
				...
				<li>
					<span onClick={this.handleLayoutTypes.bind(this, LAYOUT_TYPE_FULL)} className={`gx-pointer ${layoutType === LAYOUT_TYPE_FULL && "active"}`}>
	...
	getNavStyles = navStyle => {
		return (
			<ul className="gx-nav-option gx-list-inline">
				<li>
					<span onClick={this.onNavStyleChange.bind(this, NAV_STYLE_FIXED)} className={`gx-pointer ${navStyle === NAV_STYLE_FIXED && "active"}`}>
				...
				<li>
					<span onClick={this.onNavStyleChange.bind(this, NAV_STYLE_DRAWER)} className={`gx-pointer ${navStyle === NAV_STYLE_DRAWER && "active"}`}>
