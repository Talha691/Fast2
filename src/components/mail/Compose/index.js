		...
		return (
			<Modal
				...
				<div className="gx-form-group">
					<Input placeholder="To*" onChange={event => this.setState({ to: event.target.value })} defaultValue={to} margin="normal" />
				</div>
				<div className="gx-form-group">
					<Input placeholder="Subject" onChange={event => this.setState({ subject: event.target.value })} value={subject} margin="normal" />
				</div>
				<div className="gx-form-group">
					<TextArea
						placeholder="Message"
