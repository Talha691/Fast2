...
import {Area, AreaChart, BarChart, ResponsiveContainer, Tooltip, XAxis, YAxis, Bar} from "recharts";
...
class Chart extends React.Component {
	...
	UNSAFE_componentWillReceiveProps(nextProps) {
		this.transformData(nextProps.adminInsurances ?? nextProps.truckInsurances)
	}
		...
		return (
			<Widget styleName="gx-card-full gx-grahp-card">
				<div className="ant-row-flex gx-px-4 gx-pt-4">
					<h2 className="h4 gx-mb-3">Truck Insurances</h2>
				...
				<ResponsiveContainer className="gx-graph-chart gx-rounded-lg" width="100%" height={380}>
					<BarChart data={this.state[this.state.data].slice()} margin={{top: 25, right: 0, left: 0, bottom: 0}}>
