...
class FirebaseCRUD extends Component {
	...
	onShowUsers = (agent) => {
		this.props.history.push("/agents/" + agent);
	};
	...
	render() {
		...
		const columns = [
			...
			{...this.getColumnSearchProps("company"), title: "Company", dataIndex: "company", key: "company", onFilter: (value, record) => record.name.indexOf(value) === 0, sorter: (a, b) => a.name.length - b.name.length},
			{...this.getColumnSearchProps("name"), title: "Name", dataIndex: "name", key: "name", onFilter: (value, record) => record.name.indexOf(value) === 0, sorter: (a, b) => a.name.length - b.name.length},
			{...this.getColumnSearchProps("email"), title: "Email", dataIndex: "email", key: "email", onFilter: (value, record) => record.email.indexOf(value) === 0, sorter: (a, b) => a.email.length - b.email.length},
			{...this.getColumnSearchProps("phone"), title: "Phone", dataIndex: "phone", key: "phone", onFilter: (value, record) => record.phone.indexOf(value) === 0, sorter: (a, b) => a.phone.length - b.phone.length},
			{
